...
use TensicAI\SDK\Endpoint\DeleteTeamsTeamId;
use TensicAI\SDK\Endpoint\DeleteTeamsTeamIdAdminsUsername;
use TensicAI\SDK\Endpoint\DeleteTeamsTeamIdAudioGeneratorsGeneratorName;
use TensicAI\SDK\Endpoint\DeleteTeamsTeamIdEmbeddingsEmbeddingId;
use TensicAI\SDK\Endpoint\DeleteTeamsTeamIdImageGeneratorsGeneratorName;
use TensicAI\SDK\Endpoint\DeleteTeamsTeamIdLlmsLlmId;
use TensicAI\SDK\Endpoint\DeleteTeamsTeamIdProjectsProjectId;
use TensicAI\SDK\Endpoint\DeleteTeamsTeamIdUsersUsername;
use TensicAI\SDK\Endpoint\GetInvitations;
use TensicAI\SDK\Endpoint\GetInvitationsCount;
use TensicAI\SDK\Endpoint\GetTeams;
use TensicAI\SDK\Endpoint\GetTeamsTeamId;
use TensicAI\SDK\Endpoint\GetTeamsTeamIdAnalytics;
use TensicAI\SDK\Endpoint\GetTeamsTeamIdBranding;
use TensicAI\SDK\Endpoint\GetTeamsTeamIdMembersBudgets;
use TensicAI\SDK\Endpoint\GetTeamsTeamIdTransactions;
use TensicAI\SDK\Endpoint\PatchTeamsTeamId;
use TensicAI\SDK\Endpoint\PatchTeamsTeamIdMembersUsernameBudget;
use TensicAI\SDK\Endpoint\PostInvitationsInvitationIdAccept;
use TensicAI\SDK\Endpoint\PostInvitationsInvitationIdDecline;
use TensicAI\SDK\Endpoint\PostInvitationsProjectsInvitationIdAccept;
use TensicAI\SDK\Endpoint\PostInvitationsProjectsInvitationIdDecline;
use TensicAI\SDK\Endpoint\PostTeams;
use TensicAI\SDK\Endpoint\PostTeamsTeamIdInvitations;
use TensicAI\SDK\Endpoint\PutTeamsTeamIdAdminsUsername;
use TensicAI\SDK\Endpoint\PutTeamsTeamIdAudioGeneratorsGeneratorName;
use TensicAI\SDK\Endpoint\PutTeamsTeamIdEmbeddingsEmbeddingId;
use TensicAI\SDK\Endpoint\PutTeamsTeamIdImageGeneratorsGeneratorName;
use TensicAI\SDK\Endpoint\PutTeamsTeamIdLlmsLlmId;
use TensicAI\SDK\Endpoint\PutTeamsTeamIdProjectsProjectId;
use TensicAI\SDK\Endpoint\PutTeamsTeamIdUsersUsername;
