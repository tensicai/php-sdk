...
use TeamBlue\TensicAI\SDK\Default\DockerTestRequestDefault;

final class DockerTestRequest implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use DockerTestRequestDefault;
