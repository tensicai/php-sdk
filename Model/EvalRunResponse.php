...
use TeamBlue\TensicAI\SDK\Default\EvalRunResponseDefault;
use TeamBlue\ValueObjects\Implementation\String\DateTimeValue;

final class EvalRunResponse implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use EvalRunResponseDefault;
