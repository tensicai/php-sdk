...
use TeamBlue\TensicAI\SDK\Default\ImageGeneratorModelDefault;

final class ImageGeneratorModel implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use ImageGeneratorModelDefault;
