...
use TeamBlue\TensicAI\SDK\Default\MCPProbeRequestDefault;

final class MCPProbeRequest implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use MCPProbeRequestDefault;
