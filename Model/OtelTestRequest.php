...
use TeamBlue\TensicAI\SDK\Default\OtelTestRequestDefault;

final class OtelTestRequest implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use OtelTestRequestDefault;
