...
use TeamBlue\TensicAI\SDK\Default\PostLlmsTestBodyDefault;

final class PostLlmsTestBody implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use PostLlmsTestBodyDefault;
