...
use TeamBlue\TensicAI\SDK\Default\PostSettingsDoclingTestBodyDefault;

final class PostSettingsDoclingTestBody implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use PostSettingsDoclingTestBodyDefault;
