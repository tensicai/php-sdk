...
use TeamBlue\TensicAI\SDK\Default\ProjectOptionsDefault;

final class ProjectOptions implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use ProjectOptionsDefault;
