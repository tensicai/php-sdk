...
use TeamBlue\TensicAI\SDK\Default\RoutineCreateDefault;

final class RoutineCreate implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use RoutineCreateDefault;
