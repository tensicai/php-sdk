...
use TeamBlue\TensicAI\SDK\Default\SettingsResponseDefault;

final class SettingsResponse implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use SettingsResponseDefault;
...
// phpcs:disable Squiz.NamingConventions.ValidVariableName.MemberNotCamelCaps
    ...
    private bool $hideBranding;
    private int $maxAudioUploadSize;
    private string|null $currency = 'EUR';
    private string|null $doclingVlmUrl = null;
    private string|null $doclingVlmModel = null;
    private string|null $doclingVlmApiKey = null;
    private bool|null $authDisableLocal = false;
    private bool|null $ssoAutoCreateUser = false;
    private string|null $ssoAllowedDomains = null;
    private bool|null $ssoAutoRestricted = true;
    ...
    private int|null $dockerTimeout = 900;
    private string|null $dockerMemLimit = '512m';
    private float|null $dockerCpus = 0.5;
    private string|null $dockerNetwork = null;
    private bool|null $dockerReadOnly = false;
    private string|null $dockerHeaderName = null;
    private string|null $dockerHeaderValue = null;
    private string|null $sandboxRuntime = 'docker';
    private bool|null $sandboxManaged = false;
    private string|null $e2bApiKey = null;
    private string|null $e2bTemplate = null;
    private string|null $e2bDomain = null;
    private int|null $e2bTimeout = 900;
    ...
    private int|null $k8sTimeout = 900;
    private string|null $k8sResourceLimits = null;
    private string|null $k8sCaCert = null;
    private bool|null $k8sVerifySsl = true;
    private string|null $k8sRuntimeClass = null;
    private int|null $dataRetentionDays = 30;
    private bool|null $enforce2fa = false;
    private int|null $passwordMaxAgeDays = 0;
    private bool|null $ldapEnabled = false;
    ...
    private bool|null $observabilityCaptureContent = false;
    ...
    private bool|null $allowUserLlmCreation = true;
    private bool|null $maintenanceMode = false;
    private bool|null $mcpServerEnabled = false;
    /** @var array<mixed>|null */
    private array|null $plan = null;
    ...
    public function hideBranding(): bool
    {
        return $this->hideBranding;
    }

    public function maxAudioUploadSize(): int
    {
    ...
    public function sandboxManaged(): bool|null
    {
        return $this->sandboxManaged;
    }
    ...
    public function allowUserLlmCreation(): bool|null
    {
        return $this->allowUserLlmCreation;
    }
    ...
    public function plan(): array|null
    {
        return $this->plan;
    }
    ...
    public function keyMapping(): array
    {
        return [
            ...
            'sandbox_managed' => 'sandboxManaged',
            ...
            'allow_user_llm_creation' => 'allowUserLlmCreation',
