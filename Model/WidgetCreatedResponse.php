...
use TeamBlue\TensicAI\SDK\Default\WidgetCreatedResponseDefault;
use TeamBlue\ValueObjects\Implementation\String\DateTimeValue;

final class WidgetCreatedResponse implements SpecialKeySupport, JsonSchemaAwareRecord
{
    use WidgetCreatedResponseDefault;
